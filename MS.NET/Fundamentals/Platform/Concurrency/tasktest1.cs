...
static class Program
{
	public static void Main()
	{
		...
		Task<string> job1 = Task<string>.Factory.StartNew(t1.Translate, p1);

		Console.Write("Part (2/2): ");
		string p2 = Console.ReadLine();
		Translator t2 = new Translator(60);
		//string r2 = t2.Translate(p2);
		Task<string> job2 = Task<string>.Factory.StartNew(t2.Translate, p2);

		//string r = r1 + " AND " + r2;
		string r = job1.Result + " AND " + job2.Result;
